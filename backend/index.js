...
.command('add <file>',"Add files to repository",(yargs)=>{yargs.positional("file",{describe :"File to add to staging area",type:"string",});},addRepo)
.command('commit <message>',"Commit the changes",(yargs)=>{yargs.positional("message",{describe :"Commit changes",type:"string",});},commitRepo)
.command('pull',"Pull a repository",{},pullRepo)
.command('push',"Push a repository",{},pushRepo)
.command('revert <commitID>',"Revert to previous commit",(yargs)=>{yargs.positional("commitID",{describe :"Commit ID to revert",type:"string",});},revertRepo)
